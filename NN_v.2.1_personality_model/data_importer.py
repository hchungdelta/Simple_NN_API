...
def Input_training_data():
    ...
    with open("training_data/per_label.json",'r',encoding='utf-8') as jsonfile:
        _dicts = json.load(jsonfile)
        persona_label = _dicts["persona_label"]
        encoder_inputs_data = _dicts["encoder_inputs_data"]
        decoder_targets_data = _dicts["decoder_targets_data"]
    ...
    return encoder_inputs_data, decoder_targets_data, persona_label
